...
public class MyController {	
	...
	@RequestMapping(value="/product/ECPayServer", produces="text/html;charset=utf-8") //預設response的字元編碼為ISO-8859-1
	@ResponseBody
	...
	private String genAioCheckOutALL(HttpServletRequest request ){	
		...
		obj.setOrderResultURL("http://localhost:8081/ECPayServer3"); 
